...
console.log(thousandth(12324335345454)); // 12,324,335,345,454

// 分析
// 方法1 ： 先把字段穿倒过来，然后再用前边的这个正则处理。(繁琐)
console.log('12324335345454'.replace(/(\d{3})/g, '$1,')); // 123,243,353,454,54
console.log('12324335345454'.split('').reverse().join('').replace(/(\d{3})/g, '$1,').split('').reverse().join('')); // 12,324,335,345,454

// 方法2
// 匹配数字
console.log('12324335345454'.replace(/(\d)/g, '$1,')); // 1,2,3,2,4,3,3,5,3,4,5,4,5,4,
// 匹配三位一组 的分割位置
console.log('12324335345454'.replace(/(\d)(\d{3})/, '$1,')); // 1,4335345454
console.log('12324335345454'.replace(/(\d)(\d{3})+/, '$1,')); // 1,4
// 每一组都是三个 而不是只有一个
console.log('12324335345454'.replace(/(\d)(?=(\d{3})+)/, '$1,')); // 1,2324335345454
console.log('12324335345454'.replace(/(\d)(?=(\d{3})+$)/, '$1,')); // 12,324335345454
// 加上全部匹配
console.log('12324335345454'.replace(/(\d)(?=(\d{3})+$)/g, '$1,')); // 12,324,335,345,454
// 小数点
console.log('12324335345454.123123123'.replace(/(\d)(?=(\d{3})+(\.\d+)$)/g, '$1,')); // 12,324,335,345,454.123123123
```